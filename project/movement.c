...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/12/18 12:17:30 by hoel-mos          #+#    #+#             */
/*   Updated: 2025/12/18 13:53:27 by hoel-mos         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	movement_calculations(t_game *game, float *new_x, float *new_y, int sgn)
{
	...
	{
		*new_x = game->map->pp_x + cos(game->map->player_angle - PI / 2)
			* MOVE_SPEED;
		*new_y = game->map->pp_y + sin(game->map->player_angle - PI / 2)
			* MOVE_SPEED;
	}
	else if (sgn == 4)
	{
