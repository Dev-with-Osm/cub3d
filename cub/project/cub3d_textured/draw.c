...
void draw_ray(t_game *game, t_player *player, int ray_color) // not needed in the project it's just for  better understanding of the raycasting concept 
{
    ...
    game->ray->ray_x = player->player_x;  // gameart at player position
    game->ray->ray_y = player->player_y;
...
void draw_player(t_game *game)
{
    ...
    int player_x = (int)(player->player_x * tile);
    int player_y = (int)(player->player_y * tile);
    int radius = 4;
    int y;
    int x;
