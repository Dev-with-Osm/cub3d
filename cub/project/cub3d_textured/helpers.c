...
void movement(t_game *game, float *new_x, float *new_y, int check_dir)
{
    ...
    if(check_dir == 1)
    {
        *new_x = game->player->player_x + cos(game->player->player_angle) * MOVE_SPEED;
        *new_y = game->player->player_y + sin(game->player->player_angle) * MOVE_SPEED;
    }
    else if(check_dir == 2)
    {
        *new_x = game->player->player_x - cos(game->player->player_angle) * MOVE_SPEED;
    ...
    {
        *new_x = game->player->player_x + cos(game->player->player_angle - PI/2) * MOVE_SPEED;
        *new_y = game->player->player_y + sin(game->player->player_angle - PI/2) * MOVE_SPEED;
    }
    else if(check_dir == 4)
    {
        *new_x = game->player->player_x + cos(game->player->player_angle + PI/2) * MOVE_SPEED;
...
void process_movement(t_game *game)
{
    ...
    if (move_angle != -1) {
        float new_x = game->player->player_x + cos(move_angle) * MOVE_SPEED;
        float new_y = game->player->player_y + sin(move_angle) * MOVE_SPEED;
